...
function addToCart(e){
    ...
    var form      = $(this).parents('form'),
        ...
        start     = form.find('[name="properties[booking-start]"]').val(),
        finish    = form.find('[name="properties[booking-finish]"]').val();
    ...
    $.ajax({
        ...
        async: false,
        cache: false,
        data: 'quantity=' + quantity + '&id=' + id + '&properties[booking-start]=' + start + '&properties[booking-finish]=' + finish,
        dataType: 'json',
        error: addToCartFail,
